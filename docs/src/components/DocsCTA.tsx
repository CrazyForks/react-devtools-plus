...
export const DocsCTA: React.FC = () => {
  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} id="docs" className="relative overflow-hidden py-12 sm:py-20">
      ...
      <div className="container relative mx-auto px-4 sm:px-6">
        ...
        <div
          className={`overflow-hidden border border-white/10 rounded-2xl bg-white/[0.03] p-5 transition-all duration-700 ease-out sm:rounded-3xl md:p-14 sm:p-10 ${
            ...
            >
              ...
              <div className="relative border border-white/10 rounded-2xl bg-slate-950/80 p-4 shadow-2xl sm:rounded-3xl sm:p-6">
                ...
                <div className="text-xs text-slate-200 font-mono space-y-2 sm:text-sm sm:space-y-3">
                  <div
                    className={`flex items-center justify-between border border-white/5 rounded-xl bg-white/5 px-3 py-2 transition-all duration-500 sm:rounded-2xl sm:px-4 sm:py-3 ${
                  ...
                  <div
                    className={`border border-white/5 rounded-xl bg-white/5 px-3 py-2 transition-all duration-500 sm:rounded-2xl sm:px-4 sm:py-3 ${
                      isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                    }`}

      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="mb-8 flex flex-col items-center justify-between gap-6 text-center sm:mb-12 md:flex-row sm:gap-8 md:text-left">
          ...
          <div className="flex gap-5 sm:gap-6">
            <a href="#" className="text-slate-400 transition-colors hover:text-white"><Github className="h-5 w-5 sm:h-6 sm:w-6" /></a>
        ...
        <div className="flex flex-col items-center justify-between gap-3 border-t border-white/5 pt-6 text-xs text-slate-500 md:flex-row sm:gap-0 sm:pt-8 sm:text-sm">

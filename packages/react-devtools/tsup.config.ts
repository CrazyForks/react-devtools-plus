...
export default defineConfig([
  ...
  // Source attribute loader - CJS only (webpack loaders must be CJS)
  {
    entry: ['src/utils/source-attribute-loader.ts'],
    format: ['cjs'],
    target: 'es2017',
    dts: false,
    outDir: 'dist/utils',
  ...
  // Scan entry - bundle @react-devtools/scan without resolving its types
  {
    entry: ['src/scan.ts'],
    format: ['esm', 'cjs'],
    target: 'es2017',
    ...
    onSuccess: async () => {
      // Copy type declarations from @react-devtools/scan
